...
define("REMOTE_REPOSITORY", "git@github.com/drwicked/rachelcomerford.com/invitations"); // The SSH URL to your repository
...
define("AFTER_PULL", "bundle exec jekyll build");                                              // A command to execute after successfully pulling
